document.getElementById('date_picker').addEventListener('click', function() {
	if(td_main.style.height == '120px'){
		document.querySelector('#td_main').style.height = '260px';
		document.querySelector('#date_holder').style.marginTop = '2%';
		document.querySelector('#date_picker').style.transform = 'rotate(180deg)';
	}
	else{
		document.querySelector('#td_main').style.height = '120px';
		document.querySelector('#date_holder').style.marginTop = '7%';
		document.querySelector('#date_picker').style.transform = 'rotate(0deg)';		
	}
